...
<div class="w-12 h-12 rounded-full bg-amber-900/30 flex items-center justify-center border border-amber-500 text-amber-500">
<i data-lucide="book" class="w-6 h-6"></i>
</div>
<div>
<h2 class="text-2xl font-bold font-mono">PILOT LOGBOOK (EXPERIENCE)</h2>
<p class="text-gray-400 font-mono text-sm">HAORUI ZHOU // EXPERIENCE HISTORY</p>
</div>
</div>

<!-- Logbook Table Style -->
<div class="border border-gray-700 rounded overflow-hidden font-mono text-sm">
<div class="grid grid-cols-12 bg-gray-800 text-gray-400 border-b border-gray-700 py-2 px-4 text-xs font-bold">
<div class="col-span-2">DATE</div>
<div class="col-span-4 md:col-span-3">ROLE (ORG)</div>
<div class="col-span-2 hidden md:block">LOC</div>
